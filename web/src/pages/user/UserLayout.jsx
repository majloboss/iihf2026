    ...
    return (
        <div className={styles.layout}>
            <aside className={styles.sidebar}>
                ...
                <nav>
                    <NavLink to="/dashboard" className={({ isActive }) => isActive ? styles.active : ''}>
                        <img src="/menu_prehlad.png" alt="" style={{width:20,height:20,objectFit:'contain',verticalAlign:'middle',marginRight:6}} />Prehľad
                    </NavLink>
                    <NavLink to="/games"     className={({ isActive }) => isActive ? styles.active : ''}>
                        <img src="/menu_zapasy.png" alt="" style={{width:20,height:20,objectFit:'contain',verticalAlign:'middle',marginRight:6}} />Zápasy
                    </NavLink>
                    <NavLink to="/tabulky"   className={({ isActive }) => isActive ? styles.active : ''}>
                        <img src="/menu_tabulky.png" alt="" style={{width:20,height:20,objectFit:'contain',verticalAlign:'middle',marginRight:6}} />Tabuľky
                    </NavLink>
                    <NavLink to="/standings" className={({ isActive }) => isActive ? styles.active : ''}>
                        <img src="/menu_skupiny.png" alt="" style={{width:20,height:20,objectFit:'contain',verticalAlign:'middle',marginRight:6}} />Skupiny
                    </NavLink>
                    <NavLink to="/profile"   className={({ isActive }) => isActive ? styles.active : ''}>
                        <img src="/menu_profil.png" alt="" style={{width:20,height:20,objectFit:'contain',verticalAlign:'middle',marginRight:6}} />Profil
                    </NavLink>
                    <NavLink to="/pravidla"  className={({ isActive }) => isActive ? styles.active : ''}>
                        <img src="/menu_pravidla.png" alt="" style={{width:20,height:20,objectFit:'contain',verticalAlign:'middle',marginRight:6}} />Pravidlá
                    </NavLink>
                </nav>
                {profile && (
            ...
            <nav className={styles.bottomNav}>
                <NavLink to="/dashboard" className={({ isActive }) => isActive ? styles.active : ''}>
                    <img src="/menu_prehlad.png" alt="" style={{width:24,height:24,objectFit:'contain'}} />
                    <span style={{fontSize:'0.65rem',marginTop:2}}>Prehľad</span>
                </NavLink>
                <NavLink to="/games"     className={({ isActive }) => isActive ? styles.active : ''}>
                    <img src="/menu_zapasy.png" alt="" style={{width:24,height:24,objectFit:'contain'}} />
                ...
                <NavLink to="/profile" className={({ isActive }) => [styles.profileNav, isActive ? styles.active : ''].join(' ')}>
                    <div className={styles.profileNavAvatar}>
                        {profile?.avatar
                            ...
                            : <img src="/menu_profil.png" alt="" style={{width:24,height:24,objectFit:'contain'}} />
                        }
                    </div>
                    <span style={{fontSize:'0.65rem',marginTop:2}}>Profil</span>
                </NavLink>
                <NavLink to="/standings" className={({ isActive }) => isActive ? styles.active : ''}>
                    <img src="/menu_skupiny.png" alt="" style={{width:24,height:24,objectFit:'contain'}} />
                    <span style={{fontSize:'0.65rem',marginTop:2}}>Skupiny</span>
                </NavLink>
                <NavLink to="/pravidla"  className={({ isActive }) => isActive ? styles.active : ''}>
                    <img src="/menu_pravidla.png" alt="" style={{width:24,height:24,objectFit:'contain'}} />
