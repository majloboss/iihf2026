...
-- Aktualizuje fifa2026.games aj fifa2026.games_pdf (master). flashscore_url ostáva nedotknutý.
-- Bez TEMP tabuľky (kvôli DBeaver auto-commit) — inline VALUES v každom UPDATE.

UPDATE fifa2026.games g
SET start_time = k.st::timestamp, venue = k.venue, updated_at = NOW()
FROM (VALUES
...
WHERE g.game_id = k.gid;

UPDATE fifa2026.games_pdf p
SET start_time = k.st::timestamp, venue = k.venue
FROM (VALUES
    (73,  '2026-06-28 19:00:00', 'Los Angeles'),
    (74,  '2026-06-29 20:30:00', 'Boston'),
    (75,  '2026-06-30 01:00:00', 'Monterrey'),
