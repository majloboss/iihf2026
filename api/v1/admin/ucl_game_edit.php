...
// Faza z ciselnika. Prazdna hodnota zapas odviaze — filtre ho potom
// neuvidia, preto sa nastavuje vedome.
$phaseId = isset($body['phase_id']) && $body['phase_id'] !== ''
    ? (int)$body['phase_id'] : null;
