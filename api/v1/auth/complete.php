...
try {
    $env = str_contains($_SERVER['HTTP_HOST'] ?? '', 'dev_') ? 'develop' : 'main';
    $pdo->prepare("INSERT INTO admin.login_logs (user_id, username, ip_address, user_agent, env) VALUES (?,?,?,?,?)")
        ->execute([$payload['user_id'], $username,
